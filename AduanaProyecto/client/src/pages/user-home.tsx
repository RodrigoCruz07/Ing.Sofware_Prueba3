...
export default function UserHome() {
  ...
  // Simulated user data - in real app would come from auth context
  ...
  const procedures = [
    {
      ...
      link: "/procedures/import-declaration"
    },
    {
      ...
      link: "/procedures/origin-certificate"
    },
    {
      ...
      link: "/procedures/urgent-dispatch"
    },
    {
      ...
      link: "/procedures/exporter-registry"
    },
    {
      title: "Automatización de documentación para menores",
      description: "Documetación automatizada para entrada y salida de menores de edad",
      icon: Baby,
      color: "bg-pink-100 text-pink-600",
      link: "/procedures/minor-documentation"
    },
    {
      title: "Formulario de inventario contra contrabando",
      description: "Complete el formulario de inventario para optimizar el control",
      icon: Search,
      color: "bg-orange-100 text-orange-600",
      link: "/procedures/inventory-form"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Gestione sus trámites aduaneros de forma segura y eficiente
          </p>
        </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <Button 
                        ...
                        onClick={() => {
                          toast({
                            title: "En proceso...",
                            description: "Preparando formulario de trámite...",
                          });
                        }}
                      >
                        Iniciar Trámite
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Button 
                      ...
                      onClick={() => {
                        toast({
                          title: "En proceso...",
                          description: "Cargando sus solicitudes...",
                        });
                      }}
                    >
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        toast({
                          title: "En proceso...",
                          description: "Abriendo documentación para menores...",
                        });
                      }}
                    >
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        toast({
                          title: "En proceso...",
                          description: "Abriendo formulario de inventario...",
                        });
                      }}
                    >
